...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { status: @talk.status, summary: @talk.summary, template: @talk.template, title: @talk.title }
    end
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { status: @talk.status, summary: @talk.summary, template: @talk.template, title: @talk.title }
    assert_redirected_to talk_path(assigns(:talk))
  end
